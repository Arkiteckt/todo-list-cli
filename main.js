    ...
    if(choice === 1){
        ...
        selectChoice();
         ...
         //prompt the user for item number to complete
            ...
            */
           console.log("Type of index choice: " + indexChoice);
...
-print toDo list BEFORE giving user the choice to select an item
-so they know which items are available/incomplete
-conditional to check completion status
